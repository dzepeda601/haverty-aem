...
/**
 * Transformer: Havertys section breaks + section metadata.
 * Section boundaries come from tools/importer/page-templates.json sections[]
 * (selectors verified against migration-work/cleaned.html #main-content).
 *
 * Inserts <hr> before every non-first section (beforeTransform, while section
 * elements still exist) and a Section Metadata block after every styled
 * section (afterTransform, anchored to a marker <hr>). See
 * references/generate-import-transformer.md for why both hooks are required.
 */
